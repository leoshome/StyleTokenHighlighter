...
![Highlighting Demo](@StyleTokenHighlighter\screenshots\screenshots.mp4)
...
2.  **Go**: Place cursor on a highlighted token → **Right-click** → `Go to Next/Previous Highlight`.
3.  **Clear**: **Right-click** → `Clear Specific Style` or `Clear ALL highlights`.
